...
//! (`HOME`, `PATH`, `DISPLAY`, ...) so they can drive command
//! resolution deterministically. Cargo runs unit tests in parallel; without
//! serialisation those mutations race across threads. Each test that touches
//! env vars must hold this lock for its entire body.
